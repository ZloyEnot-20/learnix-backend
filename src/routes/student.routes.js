...
router.get("/language-profile/topic-catalogue", ctrl.getIeltsTopicCatalogue)
router.get("/language-profile/score-distribution", isStaff, ctrl.getLanguageProfileScoreDistribution)
...
router.get("/:id/language-profile/debug", validate(idParamSchema), ctrl.getLanguageProfileDebug)
router.get("/:id/language-profile/history", validate(idParamSchema), ctrl.getLanguageProfileHistory)
router.get("/:id/topic-masteries", validate(idParamSchema), ctrl.getStudentTopicMasteries)
router.get("/:id/ielts-estimation", validate(idParamSchema), ctrl.getIeltsEstimation)
