/**
 * Seed vocabulary decks. These are upserted into the `VocabDeck` collection by
 * the seeder so the database is the single source of truth (no data shipped in
 * the frontend bundle).
 */
function w(id, term, partOfSpeech, definition, example, translation, translationUz) {
