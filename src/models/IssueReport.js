...
const issueReportSchema = new mongoose.Schema(
  {
    ...
    liveLessonId: { type: String, index: true, default: null },
    bookId: { type: String, index: true, default: null },
...
issueReportSchema.methods.toJSON = function toJSON() {
  return {
    ...
    liveLessonId: this.liveLessonId ?? null,
    bookId: this.bookId ?? null,
    unitNumber: this.unitNumber ?? null,
    exerciseId: this.exerciseId ?? null,
    status: this.status,
